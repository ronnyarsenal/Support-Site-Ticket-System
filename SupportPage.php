  ...
  <div id="content-wrap">
    ...
    <div id="main"> <a name="TemplateInfo"></a>
      <div class="box">
        <h1>Tickets</h1>
        <ul>
            <li><label><a href=" NewTicketPage.php">Create New Tickets</a></label></li>
            <li><label><a href=" OpenTickets.php">Open Tickets</a></label></li>
            <li><label><a href=" ClosedTickets.php">Closed Tickets</a></label></li>
        </ul>
      </div>
    </div>
    <br />
